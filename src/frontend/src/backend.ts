...
export class Backend implements backendInterface {
    ...
    async createCustomer(arg0: CreateCustomer): Promise<CustomerRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.createCustomer(to_candid_CreateCustomer_n10(this._uploadFile, this._downloadFile, arg0));
                return from_candid_CustomerRecord_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async deleteAllCustomers(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteAllCustomers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByPaymentStatus(arg0: PaymentStatus): Promise<Array<CustomerRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByPaymentStatus(to_candid_PaymentStatus_n12(this._uploadFile, this._downloadFile, arg0));
    ...
    async getBalancesSum(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getBalancesSum();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalCollectedPayments(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalCollectedPayments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordPayment(arg0: string, arg1: number): Promise<CustomerRecord> {
        if (this.processError) {
            try {
    ...
    async resetTotalCollectedPayments(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetTotalCollectedPayments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchCustomers(arg0: string): Promise<Array<CustomerRecord>> {
        if (this.processError) {
            try {
    ...
    async updateCustomer(arg0: string, arg1: CreateCustomer): Promise<CustomerRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCustomer(arg0, to_candid_CreateCustomer_n10(this._uploadFile, this._downloadFile, arg1));
                return from_candid_CustomerRecord_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CustomerRecord_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CustomerRecord): CustomerRecord {
...
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CustomerRecord>): Array<CustomerRecord> {
    return value.map((x)=>from_candid_CustomerRecord_n14(_uploadFile, _downloadFile, x));
}
function to_candid_CreateCustomer_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CreateCustomer): _CreateCustomer {
